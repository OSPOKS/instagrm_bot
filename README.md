...
### Deploy to Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Thajudecodes/instagrm_bot)
...
```sh
git clone https://github.com/Thajudecodes/instagrm_bot
cd Instagram-Bot
